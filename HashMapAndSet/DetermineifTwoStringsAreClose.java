...
//    Apply Operation 2: "baaccc" -> "abbccc"
    ...
    public static boolean closeStrings(String word1, String word2) {
        ...
        List<Integer> w1valuelist = new ArrayList<>(w1.values());
        List<Integer> w2valueList = new ArrayList<>(w2.values());

        Collections.sort(w1valuelist);
        Collections.sort(w2valueList);

        return w1valuelist.equals(w2valueList);
    }
